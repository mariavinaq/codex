...
- Main feed where users can scroll through posts of latest code snippets shared by other users. By default, the posts shown will be a mix of topics/functions.
  - This will have an explorative/search functionality where users can specifically indicate the type of posts they want to see, such as front-end or back-end specific, and the feed will adjust accordingly
